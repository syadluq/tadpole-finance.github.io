...
cBat.name = 'Basic Attention Token';
cBat.id = 'bat';
cBat.index = 'basic-attention-token';
cBat.unit = 'BAT';
cBat.logo = './assets/libs/cryptocurrency-icons/svg/color/bat.svg';
cBat.cTokenDecimals = 8;
cBat.underlyingDecimals = 18;
cBat.address = '0x6c8c6b02e7b2be14d4fa6022dfd6d75921d90e4e';
cBat.underlyingaddress = '0x0d8775f648430679a709e98d2b0cb6250d2887ef';
cBat.abi =[
    {
        "inputs": [
            {
...
cBat.cToken = new web3.eth.Contract(cBat.abi, cBat.address);